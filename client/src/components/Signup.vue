            ...
            <div class="login-box well">
                    <form @submit.prevent="signupForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="signupData.username" id="username-email" placeholder="Username" type="text" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input id="password" v-model="signupData.password" placeholder="Password" type="password" class="form-control" />
                        </div>
